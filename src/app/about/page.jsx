...
export default function About() {
	return (
		<div className="text-white mx-auto max-w-screen-lg grid md:grid-cols-2 gap-12 p-6 bg-black-blue m-8 rounded-2xl">
			<section className="md:mb-8 bg-dark-blue p-8 rounded-2xl shadow-lg">
			...
			<section className="md:mb-8 bg-dark-blue p-8 rounded-2xl shadow-lg">
				...
				<div className="flex flex-col space-y-4">
					...
					<Link
						...
						className="flex items-center space-x-2 textwhite hover:text-gray-400"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="20"
					...
					<Link
						...
						className="flex items-center space-x-2 text-white hover:text-gray-600"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							width="20"
			...
			<section className="mb-8 bg-dark-blue p-8 rounded-2xl shadow-lg md:col-span-2">
